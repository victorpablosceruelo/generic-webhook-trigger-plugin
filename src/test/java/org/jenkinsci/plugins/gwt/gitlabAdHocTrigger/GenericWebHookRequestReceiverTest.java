...
public class GenericWebHookRequestReceiverTest {
  ...
  public void testThatMessageIsCreatedFromExceptionWithStacktrace() {
    ...
    assertThat(actual) //
        .startsWith(
            "Exception occurred (class java.lang.IndexOutOfBoundsException: null), full stack trace in Jenkins server log. Thrown in: org.jenkinsci.plugins.gwt.gitlabAdHocTrigger.GenericWebHookRequestReceiverTest:");
  }
}
